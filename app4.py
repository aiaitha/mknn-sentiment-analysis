...
# Memuat file tambahan untuk preprocessing
...
if uploaded_files:
    ...
    for file in uploaded_files:
        ...
        try:
            test_data["cleaned_reviews"] = test_data["reviews"].apply(
                lambda x: " ".join(preprocess_text(x, normalize_words, stopwords_words, kata_dasar))
            )
            X_test_cleaned = test_data["cleaned_reviews"].tolist()
